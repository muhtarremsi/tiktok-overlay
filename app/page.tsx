...
function DashboardContent() {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case "sounds": return <div className="p-20 text-center text-zinc-800 font-black italic uppercase tracking-widest">Sound alerts library coming soon</div>;
        ...
        <div className="mb-6 space-y-4 font-sans">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-[#0c0c0e] border border-zinc-800 text-zinc-200 text-[13px] rounded-lg py-2.5 pl-8 focus:outline-none focus:border-zinc-600 transition-all lowercase placeholder:capitalize" 
            />
    ...
    <div className="p-10 max-w-5xl mx-auto space-y-10 uppercase font-bold italic font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 not-italic">
        ...
        <div className="bg-[#0c0c0e] p-8 rounded-2xl border border-zinc-800 flex flex-col justify-between shadow-xl">
          ...
          <button onClick={handleLogin} disabled={loading} className="mt-6 w-full bg-white text-black py-4 rounded-xl text-[11px] font-black uppercase flex items-center justify-center gap-2 hover:bg-zinc-200 transition-all shadow-xl active:scale-95">
    ...
    <div className="p-10 max-w-6xl mx-auto space-y-10 uppercase italic font-sans font-bold">
      ...
      <div className="grid grid-cols-2 gap-10">
        ...
        <div className="space-y-3">
          <label className="text-[10px] text-zinc-500 italic uppercase tracking-widest font-black">Video URL (.MP4)</label>
          <textarea value={url} onChange={(e) => setUrl(e.target.value)} className="w-full bg-[#0c0c0e] border border-zinc-800 rounded-lg p-4 text-zinc-400 font-mono text-[10px] min-h-[160px] focus:border-zinc-600 outline-none not-italic shadow-inner" />
        </div>
      </div>
