...
function LandingPage({ onLaunch }: { onLaunch: () => void }) {
  return (
    <div className="min-h-screen bg-[#09090b] text-white font-sans selection:bg-green-500/30 overflow-hidden relative flex flex-col">
      ...
      {/* SVG FILTER REMOVED - Caused edge artifacts over video */}
      ...
      {/* NAVBAR: ULTRA-PREMIUM FROSTED GLASS (Flawless edges) */}
      <nav className="fixed top-0 w-full z-50 h-14 md:h-24 transition-all duration-300 overflow-hidden
        bg-white/[0.01] /* Extremely transparent base */
        backdrop-blur-2xl /* Heavy, premium blur */
        backdrop-saturate-[1.6] /* Boosts colors behind the glass significantly */
        border-b border-white/5 /* Subtle bottom edge */
        shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] /* Inner top highlight for depth */
      ">
      ...
      <div className="relative flex-1 flex flex-col justify-center items-center px-4 text-center z-20 pt-24 md:pt-32">
        <div className="max-w-4xl mx-auto space-y-6 md:space-y-8 w-full">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-green-500/30 bg-green-500/10 text-green-400 text-[10px] font-bold uppercase tracking-widest backdrop-blur-sm">
            <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span> v0.030091 Premium-Glass
          </div>
