...
function DashboardContent() {
  ...
  // DER STABILE LIVE-CHECK (Logik aus FcyMn4hTCxT4AKn28ZKznZUohWN4)
  useEffect(() => {
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case "sounds": return <div className="p-20 text-center text-zinc-800 font-black italic uppercase">Sound Alerts Module</div>;
    ...
    <div className="p-10 max-w-5xl mx-auto space-y-10 uppercase font-bold italic font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 not-italic">
        ...
        <div className="bg-[#0c0c0e] p-8 rounded-2xl border border-zinc-800 flex flex-col justify-between shadow-xl">
          ...
          <button onClick={handleLogin} className="mt-6 w-full bg-white text-black py-4 rounded-xl text-[11px] font-black uppercase flex items-center justify-center gap-2 hover:bg-zinc-200 transition-all">
